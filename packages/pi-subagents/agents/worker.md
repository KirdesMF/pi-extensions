...
- **reviewer** — reads your changed files and catches bugs, edge cases, missing error handling. Dispatch AFTER you finish editing so you don't ship bad code.
...
Prefer dispatching **reviewer** after all edits — it catches what you missed.
